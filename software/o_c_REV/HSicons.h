...
const uint8_t TR_ICON[8]      = {0x00, 0x00, 0x1c, 0x1c, 0x1c, 0x00, 0x00, 0x00 };
const uint8_t GATE_ICON[8]       = {0x40, 0x7e, 0x02, 0x02, 0x02, 0x7e, 0x40, 0x40}; // rename to GATE_ICON?
const uint8_t SLEW_ICON[8]       = { 0x40, 0x7e, 0x02, 0x02, 0x0c, 0x30, 0x40, 0x40}; 
const uint8_t LOOP_ICON[8]       = { 0x0a, 0x01, 0x09, 0x22, 0x48, 0x40, 0x28, 0x00 };
...
const uint8_t MOD_ICON[8]        = { 0x20, 0x18, 0x04, 0x08, 0x08, 0x10, 0x20, 0x20 };
...
const uint8_t LINK_ICON[8]       = { 0x18, 0x24, 0x24, 0x10, 0x08, 0x24, 0x24, 0x18};
...
const uint8_t SUP_ONE[3]      = {0x02, 0x0f, 0x00};
const uint8_t SUB_TWO[3]      = {0x00, 0xd0, 0xb0,};
