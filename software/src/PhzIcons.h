...
const uint8_t bigEnigma[8] = { 0x3c, 0x7e, 0xf7, 0xff, 0xdd, 0xff, 0x7e, 0x3c };
...
const uint8_t clock_warp[8] = { 0x91, 0x20, 0x26, 0x01, 0x80, 0x64, 0x04, 0x89 };
const uint8_t toBeNamed[8] = { 0x91, 0x00, 0x24, 0x01, 0x80, 0x24, 0x00, 0x89 };
